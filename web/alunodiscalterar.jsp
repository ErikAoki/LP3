      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Alterar
            <span class="text-primary">aluno/disciplina/nota</span>
          </h1>
          <div class="subheading mb-5">
           ...
           <form class="container" action="FrontController" method="post">
            <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-form-label" for="cod_disciplina">Código novo da disciplina: </label>
                    <input type="text" class="form-control" name="cod_disciplina" id="cod_disciplina" placeholder="Código novo da disciplina">
                </div>
                <div class="form-group">
                    <label class="col-form-label" for="nota_aluno">Nova nota do aluno: </label>
                    <input type="text" class="form-control" name="nota_aluno" id="nota_aluno" placeholder="Nova nota do aluno">
                </div>
