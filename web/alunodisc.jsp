  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Escolha uma
            <span class="text-primary">opção</span>
          </h1>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                      ...
                      Inserir aluno/disciplina/nota
                    </label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="opcao" value="procurar">
                        Procurar aluno/disciplina/nota
                    </label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="opcao" value="alterar">
                        Alterar aluno/disciplina/nota
                    </label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="opcao" value="deletar">
                        Deletar aluno/disciplina/nota
                    </label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="opcao" value="todos">
                        Ver todos os alunos/disciplinas/notas
                    </label>
                </div>
                <button class="btn btn-outline-danger" type="submit" name="control" value="Pagina2">Enviar</button>
                <button class="btn btn-outline-danger" type="submit" name="control" value="Index">Voltar</button>
            </div>
        </form>
        </div>
      </section>
